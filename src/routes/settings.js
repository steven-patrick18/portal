...
const FEATURE_SECTIONS = [
  ...
  { title: 'Sales', features: [
    ...
    { key: 'visits',           label: 'Field Visits & Prospects', desc: 'Geo-tagged visits with photos. "limited" = log own visits; the sub-pages below can be tuned separately.' },
    { key: 'visits_prospects', label: 'Prospects',               desc: 'New-shop prospects list + promote a prospect → dealer. Inherits Field Visits unless set here.', parent: 'visits' },
