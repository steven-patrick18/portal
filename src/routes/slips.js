...
const PREFIX = {
  ...
  'size-chart': 'SZC', 'size-chart-shirt': 'SZS', 'size-chart-tshirt': 'SZT', 'size-chart-jacket': 'SZJ', 'qc-final-100': 'FQC',
...
const TEMPLATES = [
  ...
  },
  {
    ...
    name: 'Size Chart — Jeans / Trousers', nameHi: 'साइज़ चार्ट — जीन्स / पैंट',
    desc: 'Export-standard bottom-wear measurement points — before/after wash.',
    ...
    note: 'Write the SPEC from the style\'s master size chart, then the measured value in each size column. Denim must be measured AFTER wash. / मास्टर साइज़ चार्ट से स्पेक लिखें, फिर हर साइज़ का नापा माप। डेनिम धुलाई के बाद नापें।',
    signs: ['QC / चेकर', 'Pattern Master / पैटर्न मास्टर', 'Production Manager / मैनेजर'],
    seal: true,
  },
  {
    key: 'size-chart-shirt', group: 'Washing & Quality', groupHi: 'धुलाई / चेकिंग', icon: 'bi-rulers',
    name: 'Size Chart — Shirt (Woven)', nameHi: 'साइज़ चार्ट — शर्ट',
    desc: 'Export-standard woven-shirt measurement points, buyer tech-pack style.',
    fields: ['Date / दिनांक', 'Style / स्टाइल', 'Batch / Lot No / बैच नं', 'Stage: Before ▢ / After wash ▢ / धुलाई से पहले-बाद', 'Fabric & Shrinkage % / कपड़ा व सिकुड़न', 'Pcs checked per size / प्रति साइज़ नग'],
    table: {
      cols: ['Measurement / माप', 'Tol ± / छूट', 'Size ___', 'Size ___', 'Size ___', 'Size ___', 'Size ___', 'Size ___'],
      rowLabels: ['Collar / कॉलर', 'Across shoulder / कंधा', 'Chest — 1" below armhole / छाती', 'Waist / कमर', 'Bottom sweep / नीचे घेरा', 'Front length from HPS / लंबाई (कंधे से)', 'Sleeve length / आस्तीन लंबाई', 'Armhole (straight) / आर्महोल', 'Bicep / बाइसेप', 'Cuff width / कफ', 'Back yoke height / योक', 'Pocket W × H / जेब', '', ''],
    },
    note: 'Measure the garment FLAT, points as per buyer tech pack (length from High Point Shoulder). Washed programs: measure AFTER wash. / गारमेंट को समतल रख कर नापें (लंबाई कंधे के ऊँचे बिंदु से)। धुले प्रोग्राम धुलाई के बाद नापें।',
    signs: ['QC / चेकर', 'Pattern Master / पैटर्न मास्टर', 'Production Manager / मैनेजर'],
    seal: true,
  },
  {
    key: 'size-chart-tshirt', group: 'Washing & Quality', groupHi: 'धुलाई / चेकिंग', icon: 'bi-rulers',
    name: 'Size Chart — T-shirt / Knits', nameHi: 'साइज़ चार्ट — टी-शर्ट / निट',
    desc: 'Export-standard knitwear measurement points — always after wash.',
    fields: ['Date / दिनांक', 'Style / स्टाइल', 'Batch / Lot No / बैच नं', 'Stage: Before ▢ / After wash ▢ / धुलाई से पहले-बाद', 'Fabric & GSM / कपड़ा व जीएसएम', 'Pcs checked per size / प्रति साइज़ नग'],
    table: {
      cols: ['Measurement / माप', 'Tol ± / छूट', 'Size ___', 'Size ___', 'Size ___', 'Size ___', 'Size ___', 'Size ___'],
      rowLabels: ['Chest — 1" below armhole / छाती', 'Body length from HPS / लंबाई (कंधे से)', 'Across shoulder / कंधा', 'Sleeve length / आस्तीन लंबाई', 'Sleeve opening / आस्तीन मुँह', 'Armhole (straight) / आर्महोल', 'Neck width / गला चौड़ाई', 'Front neck drop / गला गहराई', 'Bottom hem / नीचे घेरा', '', ''],
    },
    note: 'Knits stretch — measure FLAT without pulling, and ALWAYS after wash (knit shrinkage is high). / निट खिंचता है — बिना खींचे समतल नापें, और हमेशा धुलाई के बाद।',
    signs: ['QC / चेकर', 'Pattern Master / पैटर्न मास्टर', 'Production Manager / मैनेजर'],
    seal: true,
  },
  {
    key: 'size-chart-jacket', group: 'Washing & Quality', groupHi: 'धुलाई / चेकिंग', icon: 'bi-rulers',
    name: 'Size Chart — Jacket', nameHi: 'साइज़ चार्ट — जैकेट',
    desc: 'Export-standard jacket measurement points (denim/woven jackets).',
    fields: ['Date / दिनांक', 'Style / स्टाइल', 'Batch / Lot No / बैच नं', 'Stage: Before ▢ / After wash ▢ / धुलाई से पहले-बाद', 'Fabric & Shrinkage % / कपड़ा व सिकुड़न', 'Pcs checked per size / प्रति साइज़ नग'],
    table: {
      cols: ['Measurement / माप', 'Tol ± / छूट', 'Size ___', 'Size ___', 'Size ___', 'Size ___', 'Size ___', 'Size ___'],
      rowLabels: ['Chest — 1" below armhole / छाती', 'Body length from HPS / लंबाई (कंधे से)', 'Across shoulder / कंधा', 'Sleeve length / आस्तीन लंबाई', 'Cuff width / कफ', 'Bottom band / hem / नीचे बैंड', 'Armhole (straight) / आर्महोल', 'Collar / कॉलर', 'Pocket placement / जेब स्थिति', '', ''],
    },
    note: 'Measure FLAT as per buyer tech pack. Washed denim jackets: measure AFTER wash. / समतल रख कर टेक-पैक अनुसार नापें। धुली डेनिम जैकेट धुलाई के बाद नापें।',
    signs: ['QC / चेकर', 'Pattern Master / पैटर्न मास्टर', 'Production Manager / मैनेजर'],
    seal: true,
  },
  {
    key: 'qc-final-100', group: 'Washing & Quality', groupHi: 'धुलाई / चेकिंग', icon: 'bi-patch-check',
    name: 'Final QC — 100% Piece Checking', nameHi: 'फाइनल क्यूसी — हर पीस की जाँच',
    desc: 'Every piece checked against export-level checkpoints before packing.',
    big: true,
    fields: ['Date / दिनांक', 'Style / स्टाइल', 'Batch / Lot No / बैच नं', 'Lot Qty / लॉट नग', 'Checked Qty (100%) / जाँचे नग', 'Checker Name / चेकर नाम'],
    table: {
      cols: ['Checkpoint / जाँच बिंदु', 'OK / सही', 'Reject / रिजेक्ट', 'Remarks / नोट'],
      rowLabels: ['Shade matching / शेड मिलान', 'Measurement spot-check / माप जाँच', 'Stitching — SPI, broken/skip stitches / सिलाई', 'Trims — buttons, rivets, zipper working / बटन-ज़िप', 'Stains, spots, holes / दाग-छेद', 'Loose threads cut / धागे कटे', 'Pressing / ironing / प्रेस', 'Labels — brand, size, care, MRP / लेबल', 'Hangtag & packing / टैग व पैकिंग', ''],
    },
    summary: ['Total OK / कुल सही', 'Total Reject / कुल रिजेक्ट', 'Result: Pass / Fail / नतीजा'],
    note: '100% checking — EVERY piece passes through all checkpoints; rejects go back for repair and re-check. / हर पीस की पूरी जाँच — रिजेक्ट मरम्मत के बाद दोबारा जाँचें।',
    signs: ['Checker / चेकर', 'QC In-charge / क्यूसी इंचार्ज', 'Production Manager / मैनेजर'],
    seal: true,
  },
  {
